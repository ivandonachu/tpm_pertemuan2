...
public class jajargenjang extends AppCompatActivity {
    ...
    private EditText etSisiSejajar, etTinggi;//deklarasi sisi sejajar dan tinggi
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etSisiSejajar = findViewById(R.id.et_sisisejajar);
        ...
        btnHasil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    String sSisisejajar = etSisiSejajar.getText().toString();
                    String sTinggi = etTinggi.getText().toString();

                    //merubah jenis data dari string ke doubel
                    double sisisejajar = Double.parseDouble(sSisisejajar);
                    double tinggi = Double.parseDouble(sTinggi);
                    double hasil = ((sisisejajar + sisisejajar) * tinggi)/2;
